...
import { MapPopoverController } from './map-popover.controller';
  ...
  implements OnInit, OnDestroy, AfterViewInit, OnChanges
{
  ...
  private readonly popovers = inject(MapPopoverController);
  ...
  protected formatPopover(
    ...
    this.popovers.formatPopover(this.overlay, {
      id,
      coord,
      featureList,
      dfeat: this.dfeat,
      s57Features: this.s57Features,
      onModifyAnchor: () => this.modifyFeature('anchor'),
      onReadOnlyNote: () => this.popoverInfo()
    });
  }

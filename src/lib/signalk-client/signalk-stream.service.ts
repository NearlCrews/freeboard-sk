...
// suppresses the no-unsafe-* family for that legacy `any` shape; Record-typed
// message envelopes written via bracket access keep tsc happy under
// tsconfig.strict.json (Phase 1 ratchet). Public-surface tightening

...
// Grandfathered files: add the relative path here if a temporary god
// component must ship while its decomposition PR is in flight. Reference
// the roadmap phase in the comment beside each entry.
